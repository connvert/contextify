...
var WeakMap = typeof global.WeakMap !== 'undefined' ? global.WeakMap : function WeakMap(){
    var keys = [], values = [];
    return {
...
module.exports.getGlobalFromContext = function getGlobalFromContext(context){
    return contexts.get(context).getGlobal();
};